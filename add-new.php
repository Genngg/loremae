...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `bsisstudent`(`id`, `first_name`, `last_name`, `address`, `email`) VALUES (NULL,'$first_name','$last_name','$address','$email')";
