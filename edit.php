...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `bsisstudent` SET `first_name`='$first_name',`last_name`='$last_name',`address`='$address',`email`='$email' WHERE id = $id";
...
<head>
  ...
  <title>PHP BSIS STUDENT APPLICATION</title>
</head>
...
<body>
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `bsisstudent` WHERE id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
